...
def upgrade():
    ...
    drive           [foreign_key:system_drives->drive_id]
    name            [varchar]
    description     [varchar]
    ...
    ::data
    id  data_type   valid   settings   drive    name                description
    01   1           T/F     [x]        [x]      Movie - DVD         ARM session to rip DVD movies
    02   2           T/F     [x]        [x]      Movie - Blu-ray     ARM session to rip Blur-ay movies
    03   1           T/F     [x]        [x]      TV - DVD            ARM session to rip DVD TV Series
    04   2           T/F     [x]        [x]      TV - Blu-ray        ARM session to rip Blu-ray TV Series
    05   3           T/F     [x]        [x]      Music - MP3         ARM session to rip music as mp3
    06   3           T/F     [x]        [x]      Music - flac        ARM session to rip music as flac
    07   4           T/F     [x]        [x]      Data                ARM session to rip data disk
    08   1           T/F     [x]        [x]      HomeMovie - DVD     ARM session to rip dvd contents but with no
                                                                        title lookup
    09   2           T/F     [x]        [x]      HomeMovie - Blu-ray ARM session to rip dvd contents but with no
                                                                        title lookup
    10   5           T/F     [x]        [x]      ISO                 ARM session to create ISO using dd
    11   5           T/F     [x]        [x]      ISO - Rescue        ARM session to create ISO using ddrescue
    """
